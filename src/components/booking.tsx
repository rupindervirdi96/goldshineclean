...
export const Booking = ({}: BookingProps) => {
  ...
  return (
    <div
      id="home"
      className="min-w-full h-[calc(100vh-68px)] grid grid-rows-[1fr_max-content_1fr] items-center justify-center px-4"
    >
      <div>
      ...
      <form
        ...
        action=""
      >
        {/* <h1 className="text-2xl my-2">Get our service</h1> */}
