...
export const Footer = ({}: FooterProps) => {
  ...
  return (
    <div className="w-full my-12 mb-[60px] text-white grid grid-cols-[1fr_max-content_1fr]">
      <div className="flex items-start justify-end pt-5 pb-10 text-right pr-2 md:text-lg">
      ...
      <div className="flex flex-col text-xs items-start justify-start pt-6 pb-10 pl-2 md:text-sm">
        ...
        <span className="py-2 hidden md:block">goldshinecleaning.inc@gmail.com</span>

        <span className="py-2 block md:hidden">goldshinecleaning.inc</span>
        <span className="leading-[3px] block md:hidden">@gmail.com</span>
      </div>
    </div>
  );
};
